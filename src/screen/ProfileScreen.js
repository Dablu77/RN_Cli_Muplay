  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ScrollView
        ...
        <View style={{ paddingHorizontal: 10, marginTop: 30 }}>
          <TextInput
            ...
            style={{
              ...
              color: Colors.Balck,
              fontSize: 14,
              backgroundColor: Colors.withelight,
              elevation: 10,
          ...
          <View style={{ flexDirection: 'row', justifyContent: "space-between", marginHorizontal: 10, marginTop: 20, alignItems: 'center', }}>
            <View>
              ...
              <Text style={{ fontWeight: '500', color: Colors.Balck, fontSize: fontPixel(14), width: widthPixel(300) }}>
        ...
        <View style={{ height: heightPixel(170), backgroundColor: Colors.withelight, elevation: 10, }}>
          <View style={{ flexDirection: 'row', justifyContent: "space-between", marginHorizontal: 20, marginTop: 20 }}>
            <View style={{ alignItems: 'center', flexDirection: 'row', }}>
              <Image source={require('../assets/poweroff.png')} style={{ height: heightPixel(25), width: widthPixel(25), }} />
              <Text style={{ fontWeight: '900', color: Colors.Balck, fontSize: fontPixel(15), paddingLeft: 5 }}>
                LOGOUT
              </Text>
            </View>
            <TouchableOpacity>
              <Text style={{ fontWeight: '900', color: Colors.Balck, fontSize: fontPixel(15) }}>
                SARATEGIC TIMEOUT
              </Text>
            </TouchableOpacity>
          </View>
