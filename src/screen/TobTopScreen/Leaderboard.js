        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.Balck }}>
            <View style={{ height: heightPixel(200), backgroundColor: Colors.Withe, margin: 25, borderTopRightRadius: 10, borderTopLeftRadius: 10 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                    <View style={{ borderRightColor: "#d0d0d0", borderTopWidth: 1, width: 160, paddingVertical: 5, alignItems: 'center' }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                    <View style={{ borderRightColor: "#d0d0d0", paddingVertical: 5, borderTopWidth: 1, width: 160, alignItems: 'center', }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                    ...
                    <View style={{ borderTopWidth: 1, width: 150, paddingVertical: 5, alignItems: 'center' }}>
